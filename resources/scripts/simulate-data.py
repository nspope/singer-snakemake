...
parser.add_argument("--disable_hapmap", action="store_true")
parser.add_argument("--disable_filter", action="store_true")
parser.add_argument("--disable_ancestral", action="store_true")
parser.add_argument("--disable_repolarise", action="store_true")
parser.add_argument("--haploid", action="store_true")
parser.add_argument("--output_prefix", default="example/example", type=str)
