...
calldata = calldata[~bitmask[positions - 1]]
variant_chrom = variant_chrom[~bitmask[positions - 1]]
variant_id = variant_id[~bitmask[positions - 1]]
ref_allele = ref_allele[~bitmask[positions - 1]]
alt_allele = alt_allele[~bitmask[positions - 1]]
polarised = polarised[~bitmask[positions - 1]]
